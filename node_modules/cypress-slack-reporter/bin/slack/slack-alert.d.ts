...
export declare const slackRunner: ({ ciProvider, vcsRoot, reportDir, videoDir, screenshotDir, customUrl, onlyFailed, customText, useOnlyCustomUrl, }: SlackRunnerOptions) => Promise<string | IncomingWebhookResult[]>;
export declare const testables: {
    resolveCIProvider: (ciProvider?: string) => CiEnvVars;
    ...
    buildHTMLReportURL: ({ reportDir, artefactUrl, useOnlyCustomUrl, }: {
        reportDir: string;
        artefactUrl: string;
        useOnlyCustomUrl: boolean;
    }) => Promise<string>;
    ...
    prChecker: (ciEnvVars: CiEnvVars) => string | undefined;
